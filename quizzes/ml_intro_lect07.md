...
## 1. Select a false statement about the $k$ nearest neighbors classifier.
...
## 2. A correct formulat for the Bayes theorem is:
...
## 3. The Bayesian interpretation of the $L^2$ regularization is that
...
## 4. The naive assumption in the naive Bayes classifier is that
...
## 5. In Guassian Naive Bayes, the distribution feature $d$ given class $k$ is modeled as
...
## 6. Select a true statement about the Bernoulli Naive Bayes classifier.
